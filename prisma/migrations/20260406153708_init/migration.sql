...
-- CreateEnum
CREATE TYPE "EventStatus" AS ENUM ('DRAFT', 'PUBLISHED', 'SALE_OPEN', 'SOLD_OUT', 'COMPLETED');
...
CREATE TABLE "Event" (
    ...
    "saleOpenAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Order_reservationToken_key" ON "Order"("reservationToken");
